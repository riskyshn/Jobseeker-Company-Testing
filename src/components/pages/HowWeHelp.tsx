  ...
  return (
    <section className="py-12 md:py-24">
      <Container className="grid grid-cols-1 gap-8">
        <h2 className="mb-6 text-center text-4xl font-bold text-secondary md:text-6xl">How We Help Our Target Market</h2>
        ...
        <div>
          <h3 className="mb-3 text-center text-2xl font-semibold text-primary before:h-1 before:flex-1 before:bg-gray-100 after:h-1 after:flex-1 after:bg-gray-100 md:flex md:items-center md:gap-3 md:before:block md:before:content-['_'] md:after:block md:after:content-['_']">
            <span className="block">For Those of You Who Are Looking for Job Opportunities</span>
          </h3>
          <p className="mb-8 text-center text-lg text-textdefault md:mx-auto md:max-w-3xl">
            We help candidates in Indonesia to find the best opportunity and maximize their potential with our social recruitment platform.
          </p>
        </div>
        ...
        <div className="pt-12">
          <h3 className="mb-3 text-center text-2xl font-semibold text-secondary before:h-1 before:flex-1 before:bg-gray-100 after:h-1 after:flex-1 after:bg-gray-100 md:flex md:items-center md:gap-3 md:before:block md:before:content-['_'] md:after:block md:after:content-['_']">
            <span className="block">For Business Owner / Entreprise Who Are Looking for The Best Talent</span>
          </h3>
          <p className="mb-8 text-center text-lg text-textdefault md:mx-auto md:max-w-3xl">
            We help candidates in Indonesia to find the best opportunity and maximize their potential with our social recruitment platform.
          </p>
          ...
          <div className="grid grid-cols-1 items-center md:grid-cols-3">
            ...
            <div className="grid grid-cols-1 gap-4 p-4">
              <div>
                ...
                <h4 className="font-semibold text-secondary md:text-lg">Recruitment (ATS)</h4>
                <p className="text-xs md:text-sm">
                  Hire high quality candidates from your own talent pool with a customized job portal powered by our Applicant Tracking
                  System.
                </p>
              </div>
              <div>
                <Image alt="" src={hrisIcon} className="mx-auto block w-24" />
                <h4 className="font-semibold text-secondary md:text-lg">Management & Empowering (HRIS)</h4>
                <p className="text-xs md:text-sm">
                  Monitoring performance, managing employees, developing employees through planned activities, analyzing and planning the
                  workforce.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 items-center md:grid-cols-3">
            ...
            <div className="grid grid-cols-1 gap-4 p-4">
              <div>
                ...
                <h4 className="font-semibold text-secondary md:text-lg">Human Resource Consunting (HRC)</h4>
                <p className="text-xs md:text-sm">
                  Maximize your company's success starting from the HR Division. Our expert team is ready to become your trusted HR partner,
                  providing reliable consultation to overcome every HR challenge your company faces.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 p-4">
              <div>
                ...
                <h4 className="font-semibold text-secondary md:text-lg">ITA/SDA</h4>
                <p className="text-xs md:text-sm">
                  Explore a new era of innovation and flexibility with our trusted partners. Personalized IT solutions can empower your team
                  with precision skills and expertise, driving improvements in your projects.
                </p>
              </div>
              <div>
                <Image alt="" src={esIcon} className="mx-auto block w-24" />
                <h4 className="font-semibold text-secondary md:text-lg">Executive Search (ES)</h4>
                <p className="text-xs md:text-sm">
                  Support your recruiting team in attracting talented individuals or managing large-scale recruitment to facilitate your
