      ...
      <Container>
        <div className="border-b py-12">
          ...
          <div className="grid grid-cols-1 gap-12 py-4 md:grid-cols-2">
            <div className="grid grid-cols-2 gap-6">
              <div>
                <h5 className="mb-1 text-sm font-bold md:text-base">
                  HEADQUARTER
                </h5>
                <p className="text-xs text-textdefault md:text-sm">
                  J-Loft Office, Griya Jimbaran Hub. Jl. Karang Mas, Jimbaran.
                  Bali 80361
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-xs text-textdefault md:text-sm">
                  AD Premier Office Park, 9th Floor Jl. TB Simatupang No.5 -
                  Ragunan. Pasar Minggu South Jakarta City Jakarta 12550
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 justify-center gap-4 pb-6 pt-3 md:grid-cols-2">
          <p className="text-center text-sm md:text-left">
            Copyright © 2022 Jobseeker Company
          </p>
